...
class SlaDestinationPortTokenDecoder(tokendecoder.AbstractTokenDecoder):

    def __init__(self):
        util.log_info('Initializing SlaDestinationPortTokenDecoder')
    ...
    def decodeToken(self, dc):
        try:
            ...
            if InetAddressUtils.isIPv4Address(value) or dest_port_match is None:
                return 1
