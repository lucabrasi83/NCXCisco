...
class NetflowIPv4TokenDecoder(tokendecoder.AbstractTokenDecoder):

    def __init__(self):
        util.log_info('Initializing NetflowIPv4TokenDecoder')

    def decodeToken(self, dc):
        try:
            util.log_info('NetflowIPv4TokenDecoder: Decode token for ipv4-option and name leaf')
