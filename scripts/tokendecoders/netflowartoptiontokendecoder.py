...
class ArtOptionTokenDecoder(tokendecoder.AbstractTokenDecoder):

    def __init__(self):
        util.log_info('Initializing ArtOptionTokenDecoder')

    def decodeToken(self, dc):
        try:
            util.log_info('netflowartoptionTokenDecoder: Decode token for art option and name leaf')
