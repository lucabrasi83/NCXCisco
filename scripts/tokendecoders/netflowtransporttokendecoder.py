...
class TransportOptionTokenDecoder(tokendecoder.AbstractTokenDecoder):

    def __init__(self):
        util.log_info('Initializing TransportOptionTokenDecoder')

    def decodeToken(self, dc):
        try:
            util.log_info('TransportTokenDecoder: Decode token for transport-option and name leaf')
