...
class CounterOptionTokenDecoder(tokendecoder.AbstractTokenDecoder):

    def __init__(self):
        util.log_info('Initializing CounterOptionTokenDecoder')

    def decodeToken(self, dc):
        try:
            util.log_info('CounterOptionTokenDecoder: Decode token for name and counter option leafs')
