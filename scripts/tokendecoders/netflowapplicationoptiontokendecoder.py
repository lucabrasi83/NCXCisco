...
class ApplicationOptionTokenDecoder(tokendecoder.AbstractTokenDecoder):

    def __init__(self):
        util.log_info('Initializing ApplicationOptionTokenDecoder')

    def decodeToken(self, dc):
        try:
            util.log_info('ApplicationOptionTokenDecoder: Decode token for application option and name leaf value')
